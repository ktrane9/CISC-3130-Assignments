...
public class Assignment_2 {
  ...
  public static void play(WeeklyQueue q, Stack myStack, PrintWriter out) {
  ...
  public static void songHistory(Stack myStack, PrintWriter out) {
    System.out.println("Previous Song: " + myStack.peek());
    out.println("Previous Song: " + myStack.peek());
  }
}
